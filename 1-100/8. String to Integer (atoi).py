...
class Solution:
    def myAtoi(self, str: str) -> int:
        ...
        try:
            ...
            return 0
# Runtime: 40 ms, faster than 81.52% of Python3 online submissions for String to Integer (atoi).
# Memory Usage: 13.1 MB, less than 89.89% of Python3 online submissions for String to Integer (atoi).
