...
class Solution:
    def isNumber(self, s: str) -> bool:
        try:
            ...
            return True
# Runtime: 40 ms, faster than 78.18% of Python3 online submissions for Valid Number.
# Memory Usage: 14 MB, less than 5.46% of Python3 online submissions for Valid Number.
