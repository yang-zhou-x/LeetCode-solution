...
class Solution:
    def preorder(self, root: 'Node') -> List[int]:
        ...
        pre(root)
        return ans
# Runtime: 40 ms, faster than 99.43% of Python3 online submissions for N-ary Tree Preorder Traversal.
        ...
        while stack:
            ...
            if node:
                ...
                for child in reversed(node.children):
                    stack.append(child)
        return ans
# Runtime: 48 ms, faster than 94.37% of Python3 online submissions for N-ary Tree Preorder Traversal.
